<?php
$string['pluginname'] = 'Bloque para manejo de REAS'; //nombre del plugin... obvio
$string['simplehtml'] = 'Recursos Educativos Abiertos'; //titulo que aparecera en la lista de bloques para agregar
